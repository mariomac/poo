...
/**
 * La clase Cola implementa los métodos agregar y sacar de la superclase
 * NodosPendientes de tal manera que implementa una Cola: el primer elemento que
 * se introduce es el primer elemento que se saca (FIFO: First In, First Out).
 * <p>
