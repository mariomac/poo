...
/**
 * Implementación iterativa de la búsqueda de la ruta. Ésta será una búsqueda en
 * profundidad (depth first search) o en amplitud (breadth first search) según
 * si el atributo "pendientes" es una Pila o una Cola, respectivamente.
 */
public class BuscadorIterativo extends Buscador {
  ...
  /**
   * Construye un buscador Iterativo al que se le debe pasar una subclase de
   * NodosPendientes, pudiendo ser una Pila o una Cola.
   */
